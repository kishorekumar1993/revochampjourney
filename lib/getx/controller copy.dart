...
//     final dropdownModel = field['modelName'] ?? '${capitalLabel}Model';
//     if (type == 'Dropdown') {
...
//   final texteditingInitCalls = <String>[];
...
//       final capitalLabel = capitalize(label);
//       // final dropdownModel = item['modelName'] ?? '${capitalLabel}Model';
...
//             dropdownInitCalls.add("              debugPrint('Error loading $capitalLabel \$e');");
...
//           buffer.writeln("  var selected$capitalname = ''.obs;");
//           buffer.writeln(
