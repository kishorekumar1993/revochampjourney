...
class RevoRunsScreen extends StatefulWidget {
  const RevoRunsScreen({super.key});

  @override
  State<RevoRunsScreen> createState() => _RevoRunsScreenState();
}

class _RevoRunsScreenState extends State<RevoRunsScreen> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    // Filter runs
    final filteredRuns = _runs.where((run) {
