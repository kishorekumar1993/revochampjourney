...
// ==========================================
class RevoDashboardOverviewScreen extends StatelessWidget {
  const RevoDashboardOverviewScreen({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Overview of workspace traffic, conversions, and recent actions.",
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildJourneyPerfItem("Motor Insurance Journey", 0.88, "88% Conversion"),
                      _buildJourneyPerfItem("User KYC Onboarding", 0.72, "72% Conversion"),
                      _buildJourneyPerfItem("Personal Loan Application", 0.54, "54% Conversion"),
                      _buildJourneyPerfItem("Service Feedback Survey", 0.94, "94% Conversion"),
                    ],
                  ),
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      _buildActivityItem("Admin User updated template User KYC Onboarding", "2m ago"),
                      _buildActivityItem("Client completed #RUN-1049 successfully", "12m ago"),
                      _buildActivityItem("New journey Credit Card Setup created", "1h ago"),
                      _buildActivityItem("API Connector 'Verify PAN' test passed", "3h ago"),
                    ],
                  ),
                ),
              ),
  ...
  Widget _buildMetricsGrid() {
    final metrics = [
      {'label': 'Total Visitors', 'val': '1,492', 'change': '+12%', 'icon': Icons.trending_up_rounded, 'color': RevoTheme.secondary},
      {'label': 'Completed Flows', 'val': '840', 'change': '+8%', 'icon': Icons.task_alt_rounded, 'color': RevoTheme.primaryLight},
      {'label': 'Average Duration', 'val': '4m 12s', 'change': '-4%', 'icon': Icons.timer_outlined, 'color': RevoTheme.accent},
      {'label': 'Active Drop-off', 'val': '12.4%', 'change': '-2%', 'icon': Icons.trending_down_rounded, 'color': RevoTheme.error},
    ];
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(m['label'] as String, style: GoogleFonts.inter(fontSize: 11, color: RevoTheme.textSecondary)),
  ...
  Widget _buildJourneyPerfItem(String name, double val, String desc) {
    return Padding(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(desc, style: GoogleFonts.inter(fontSize: 11, color: RevoTheme.textSecondary)),
            ],
          ),
  ...
  Widget _buildActivityItem(String text, String time) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(Icons.circle, size: 6, color: RevoTheme.primaryLight),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(text, style: GoogleFonts.inter(fontSize: 12, color: RevoTheme.textPrimary)),
                const SizedBox(height: 2),
                Text(time, style: GoogleFonts.inter(fontSize: 10, color: RevoTheme.textSecondary)),
              ],
            ),
          ),
        ],
