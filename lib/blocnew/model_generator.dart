...
// // lib/bloc/generators/model/model_generator.dart
// //
// // Generates the Data layer Model class (fromJson / toJson).
// // Extends or wraps the domain Entity — keeps serialization out of entities.
...
//       buf.writeln('      ${f.name}: ${_jsonGetter(f, key)},');
//     }
//     buf.writeln('    );');
//     buf.writeln('  }');
//     buf.writeln();
...
//   String _jsonGetter(GeneratorField f, String key) {
//     if (f.isDateTime) {
//       if (f.isNullable) {
